        ...
        <div className="container-max">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Dashmesh Printers and Card Gallery. All rights reserved. Desinged by <a className="text-red-500 hover:underline" href="https://imaginesoftech.com" target="_blank" rel="noopener noreferrer">Imagine Softech</a>
            </p>
